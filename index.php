                                ...
                                <li class="nav-item icon-2">
                                    <a href="#" class="btn cat-btn">
                                        <div class="container-fluid">
                                            ...
                                            <div class="col">
                                                <h3>Whole Sale</h3>
                                                <p class="fs-6 text-secondary content-left">Now we opened KOPWAR ACADEMY for Student (Online Learning System)</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item icon-2">
                                    <a href="#" class="btn cat-btn">
                                        <div class="container-fluid">
                                            ...
                                            <div class="col">
                                                <h3>Distribute</h3>
                                                <p class="fs-6 text-secondary content-left">KOPWAR is an online store. Begin as a foodservice provider to business and other service. By using our app, you will never need to go to Market and get your hand dirty. *Currently available in Yangon</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item icon-2">
                                    <a href="#" class="btn cat-btn">
                                        <div class="container-fluid">
                                            ...
                                            <div class="col">
                                                <h3>Satisfaction</h3>
                                                <p class="fs-6 text-secondary content-left">With our fair and transparent pricing, you know you’ll always get a good deal.</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
